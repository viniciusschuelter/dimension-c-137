<template>
  ...
  >
    ...
    <div class="absolute text-center pt-20 pl-20" v-show="hover && (character.status === 'Dead')">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-[5rem]" fill="white">
